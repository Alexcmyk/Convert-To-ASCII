...
class Digitizer: 
  ...
  def convert_to_ascii(self):
    ...
    self.make_grayscale()
    self.adjust_contrast(2)
    self.img = self.img.resize(sample_size)
  
    ascii_img = Image.new("RGBA", final_size, color="#33076b")
...
if __name__ == "__main__":
  # Saving the images into an "inputs" variable using the glob library | Gives list of path names
